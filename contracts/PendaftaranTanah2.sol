...
contract PendaftaranTanah2 {
    ...
    mapping(string => bool) public nibTerdaftar; // Mapping untuk memastikan NIB unik
    ...
    function daftarSertifikat(
        ...
        require(!nibTerdaftar[_nib], "NIB sudah terdaftar"); // Pengecekan NIB
        ...
        nibTerdaftar[_nib] = true; // Tandai NIB sebagai terdaftar
